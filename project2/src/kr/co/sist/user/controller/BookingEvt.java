	...
	public void hairType() {
		...
		try {
			...
			for(int i=0; i<hairTypeList.size(); i++) {
				if(hairTypeList.get(i).getHairType().equals("ƒ∆")) {
					cutCount+=1;
				}else if(hairTypeList.get(i).getHairType().contains("∆ﬂ")) {
					permCount+=1;
					if(hairTypeList.get(i).getHairCategory().equals("¿œπ›∆ﬂ")) {
						justPermCnt+=1;
					}else if(hairTypeList.get(i).getHairCategory().equals("∆Øºˆ∆ﬂ")) {
						specialPermCnt+=1;
					}//end if
				}else if(hairTypeList.get(i).getHairType().contains("ø∞ªˆ")) {
					dyeCount+=1;
					if(hairTypeList.get(i).getHairCategory().equals("ø∞ªˆ")) {
						justDyeCnt+=1;
					}else if(hairTypeList.get(i).getHairCategory().equals("≈ªªˆ")) {
						bleachingCnt+=1;
					}//end if	
				}else {
					clinicCount+=1;
		...
		if(flag.equals("c")) {
			...
			for(int i=0; i<hairTypeList.size(); i++) {
				if(hairTypeList.get(i).getHairType().equals("∆ﬂ")) {
